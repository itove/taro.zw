...
function Index() {
  ...
  const gridItems = [
    ...
    { t: '文旅要闻', p: Env.iconUrl + 'grid_7.png', target: '', url: 'node/index?type=1&region=wenlv', isTab: false, },
    { t: '旅行游记', p: Env.iconUrl + 'grid_8.png', target: '', url: 'node/index?type=1&region=youji', isTab: false, },
  ]
